...
namespace Peter
{
    ...
    public class ShellContextMenu : NativeWindow
    {
        ...
        protected IntPtr[] GetPIDLs(FileSystemInfo[] arrFI)
        {
            ...
            var arrFI0 = arrFI[0];
            var arrFI0AsFileInfo = arrFI0 as FileInfo;
            IShellFolder oParentFolder = GetParentFolder(arrFI0AsFileInfo != null ? arrFI0AsFileInfo.DirectoryName :  (arrFI0 as DirectoryInfo).Parent.FullName);
    ...
    public class LocalWindowsHook
    {
        ...
        public void Install()
        {
            m_hhook = SetWindowsHookEx(
                ...
                m_filterFunc,
                IntPtr.Zero,
                (int)System.Diagnostics.Process.GetCurrentProcess().Threads[0].Id);
        }
        // ************************************************************************
